            ...
            <div className={`${className}`}>
                <div className='flex justify-between py-6  2xl:pr-5 xl:pr-5 lg:pr-5 md:pr-5 sm:pr-0 s:pr-0'>
                    ...
                    <div className='justify-between text-[#4E4D69] self-center 2xl:flex xl:flex lg:flex md:hidden sm:hidden s:hidden'>
                        ...
                        <a href="https://app.getcover.com/" target='_blank' className='text-[#ffff] 4xl:text-[20px] 3xl:text-[19px] 2xl:text-[12px] xl:text-[12px] lg:text-[12px] md:text-[12px] sm:text-[12px] s:text-[12px] font-semibold bg-[#4E4D69] rounded-lg p-3 ml-5'>LOGIN</a>
                    </div>
                    ...
                    {isVisible && (
                        <div className='fixed top-0 left-0 w-full h-screen bg-[#323148fa] backdrop-blur-2xl'>
                            ...
                            <div className='mt-8  w-full  mx-auto'>
                                ...
                                <p className='text-center my-5'><a href="https://app.getcover.com/" target='_blank' className='text-[#ffff] text-sm font-semibold bg-[#4E4D69] rounded-lg p-3'>LOGIN</a></p>
                            </div>
                        </div>
                    )}
                </div>
